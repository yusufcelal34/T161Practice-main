...
public class P16_StringMethods {
    public static void main(String[] args) {


        /** indexOf()
         * char karakter ya da String metnin kacinci indexden basladigini veren bir method dur.
         * Sonuc integer dir.
        ...
        System.out.println(str4.toLowerCase(Locale.forLanguageTag("tr"))); //
        System.out.println("----------");
